---
title: 为什么所有大模型都绕不开Transformer？RNN和CNN的短板在哪
description: 为什么所有大模型都绕不开Transformer？本文对比RNN、CNN在长距离依赖、并行计算和上下文建模上的短板，讲清Transformer通过自注意力机制解决了什么问题，以及BERT、GPT、T5、Llama等主流模型为什么都建立在Transformer架构之上。
keywords: ["Transformer", "RNN", "CNN", "大模型架构", "注意力机制"]
tags: ["Transformer", "大模型原理"]
---
