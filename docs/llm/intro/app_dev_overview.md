---
title: 大模型应用开发到底在做什么：和算法岗区别、日常关注什么、核心模块
description: 大模型应用开发到底在做什么？本文对比应用开发、算法岗、训练岗的工作对象和能力要求，讲清应用开发者日常关注的模型调用、Prompt、RAG、Agent、部署、评估、成本控制和工程优化模块，并给出初学者入门路径、项目准备、简历表达和求职面试建议。
keywords: ["大模型应用开发", "LLM应用开发", "应用开发vs算法岗", "RAG", "Agent", "大模型入门", "LLM开发岗", "大模型岗位"]
tags: ["大模型", "应用开发"]
---
...
1. 业务流程抽象建模，将复杂的业务逻辑拆解、抽象成AI可以理解和执行的标准化流程。这需要定义清楚AI在流程中扮演什么角色（如审核员、助手、创作者），需要执行哪些具体动作（如信息提取、内容生成、意图判断），输入数据和期望的输出结果；明确AI在哪个环节介入。

2. 模型交互与效果调优，提示词工程 (Prompt Engineering)，模型调用与集成，数据处理与知识库构建，效果评估与优化

3. 工程落地和风险控制，系统集成与部署，测试与监控，安全与合规审查
