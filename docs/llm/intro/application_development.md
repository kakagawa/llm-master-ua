---
title: 大模型应用开发岗、算法岗、C++/Java/Go开发岗到底什么区别？谁替代谁了吗？
description: 大模型应用开发岗位越来越多，和算法岗、传统开发岗到底是什么关系？大模型应用开发不是替代C++/Java/Go，是并列关系。系统框架依然要SpringBoot，高性能RPC依然要C++，高并发依然要Go，只是大模型应用开发是新岗位，在吸纳人员。
keywords: [大模型应用开发, 算法工程师, LLM应用工程师, Java开发, C++开发, Go开发, 大模型岗位, AI求职, Agent开发, RAG开发, 大模型转行, 后端开发]
tags: [大模型岗位, AI求职, 大模型应用开发]
---
...
如果大家想冲大模型应用开发岗，或者自己是cpp/Java/Go开发，想+LLM加分，可以报名[卡码大模型应用开发训练营](https://mp.weixin.qq.com/s/-m6l3nLWzU3mbQihl7wlKQ)
