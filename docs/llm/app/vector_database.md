---
title: 向量数据库解决了什么问题：为什么不能用MySQL做向量检索、ANN索引原理
description: 向量数据库到底解决什么问题？本文从语义检索、向量相似度、ANN近似最近邻索引、召回速度和精度权衡讲起，解释为什么MySQL不适合做大规模向量检索，对比FAISS、Milvus、Chroma等方案，并整理RAG系统设计和大模型面试常见追问与选型思路。
keywords: ["向量数据库", "ANN索引", "向量检索", "Milvus", "Pinecone", "FAISS", "RAG存储", "语义搜索"]
tags: ["RAG", "大模型应用"]
---
