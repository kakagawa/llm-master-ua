---
title: ReAct、Reflection、规划执行：Agent三种常见思路怎么选，面试怎么讲
description: ReAct、Reflection、Plan-and-Execute规划执行是Agent智能体最常见的三种设计思路。本文讲清楚ReAct为什么适合工具调用，Reflection为什么适合自我检查，规划执行为什么适合复杂任务拆解，以及面试中怎么回答Agent设计模式。
keywords: ["ReAct", "Reflection", "Plan-and-Execute", "规划执行", "Agent设计模式", "AI Agent", "大模型Agent", "Agent工具调用", "Agent面试", "大模型应用开发"]
tags: ["大模型应用", "AI Agent", "Agent设计", "大模型面试"]
---
