...
![Few-shot дає приклади перед входом, CoT розкладає кроки під час генерації, самоперевірка утворює цикл контролю після чернетки](https://file1.kamacoder.com/i/web/20260716114509_prompt_methods_01_execution_positions_compressed.png)
...
![Few-shot виводить відповідність для поточної задачі з прикладів «вхід — вихід», не змінюючи параметрів моделі](https://file1.kamacoder.com/i/web/20260716114509_prompt_methods_02_fewshot_mapping_compressed.png)
...
![Самоперевірка утворює цикл контролю й виправлення завдяки критеріям оцінювання, результатам тестів і знайденим доказам](https://file1.kamacoder.com/i/web/20260716114509_prompt_methods_03_reflection_evidence_loop_compressed.png)
