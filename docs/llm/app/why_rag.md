---
title: 为什么有了大模型还需要RAG？幻觉、私有知识、时效性四大问题
description: 为什么有了大模型还需要RAG？本文从幻觉、私有知识缺失、知识更新滞后、答案不可追溯四个问题出发，讲清RAG如何通过检索增强生成补足大模型边界，哪些场景必须使用RAG，哪些场景不适合过度上RAG，以及大模型应用开发面试中如何回答选型和落地问题。
keywords: ["RAG", "检索增强生成", "大模型幻觉", "私有知识", "RAG选型"]
tags: ["RAG", "大模型应用"]
---
