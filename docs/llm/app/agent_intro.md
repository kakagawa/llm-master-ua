...
description: Agent到底是什么，为什么它不只是更聪明的大模型问答？本文从普通问答、ChatBot、Workflow和Agent的边界讲起，拆解规划、工具调用、执行步骤、反馈迭代和任务闭环，帮助准备大模型应用开发、AI Agent项目和LLM面试的同学建立清晰认知。
keywords: ["Agent是什么", "AI Agent", "大模型Agent", "Agent和ChatBot区别", "Agent和Workflow区别", "Tool Use", "Function Calling", "ReAct", "大模型应用开发", "AI面试"]
tags: ["大模型应用", "AI Agent", "Agent入门", "大模型面试"]
---
