...
![Звичайні питання-відповіді проти агента: різниця не в тому, чи вміє він говорити, а в тому, чи вміє діяти](https://file1.kamacoder.com/i/web/20260515162836_agent_intro_01_qa_vs_agent_compressed.png)
...
![Від відповіді до дії: агент не краще говорить, а краще діє](https://file1.kamacoder.com/i/web/20260515162838_agent_intro_02_capability_ladder_compressed.png)
...
![Чотири ключові здатності агента: планування, інструменти, виконання, зворотний зв'язок](https://file1.kamacoder.com/i/web/20260515162839_agent_intro_03_four_capabilities_loop_compressed.png)
...
![Коли брати workflow, а коли справді потрібен агент](https://file1.kamacoder.com/i/web/20260515162840_agent_intro_04_workflow_agent_matrix_compressed.png)
...
![Агент — це не модель, а інженерна система](https://file1.kamacoder.com/i/web/20260515162842_agent_intro_05_system_components_compressed.png)
