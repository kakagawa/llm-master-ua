---
title: Function Calling详解：大模型怎么调用工具，为什么是Agent的基础
description: Function Calling是什么，模型调用工具本质上发生了什么？本文讲清大模型如何通过工具描述、参数Schema和结构化输出完成工具调用，和普通问答、Tool Use、Agent的关系是什么，以及为什么Function Calling是Agent工程化和AI应用开发的基础能力。
keywords: ["Function Calling", "工具调用", "Agent基础", "大模型工具", "Tool Use"]
tags: ["大模型调用", "Function Calling"]
---
