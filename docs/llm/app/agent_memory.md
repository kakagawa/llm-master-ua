...
![Рівні пам'яті агента та їхній зв'язок із забрудненням контексту](https://file1.kamacoder.com/i/web/20260526175836_agent_memory_01_memory_layers_compressed.png)
...
![Порівняння чотирьох типів пам'яті: короткострокова, Session State, довгострокова й зовнішня база знань](https://file1.kamacoder.com/i/web/20260526175837_agent_memory_02_four_types_compressed.png)
...
![Як короткострокова пам'ять фільтрує з довгої розмови конспект ключової задачі](https://file1.kamacoder.com/i/web/20260526175838_agent_memory_03_short_memory_filter_compressed.png)
...
![Session State фіксує мету, гіпотези, факти й наступні дії](https://file1.kamacoder.com/i/web/20260526175840_agent_memory_04_session_state_compressed.png)
...
![Фільтр перед записом у довгострокову пам'ять: сталість, корисність, підтвердження, відповідність вимогам](https://file1.kamacoder.com/i/web/20260526175841_agent_memory_05_write_gate_compressed.png)
...
![Процес пошуку, фільтрації, використання й оновлення довгострокової пам'яті за поточною задачею](https://file1.kamacoder.com/i/web/20260526175843_agent_memory_06_memory_retrieval_compressed.png)
...
![Межа між зовнішньою базою знань на RAG і довгостроковою пам'яттю агента](https://file1.kamacoder.com/i/web/20260526175844_agent_memory_07_rag_vs_memory_compressed.png)
...
![Механізм оновлення й забування для застарілої, суперечливої та шумної довгострокової пам'яті](https://file1.kamacoder.com/i/web/20260526175846_agent_memory_08_forgetting_update_compressed.png)
...
![Цикл системи пам'яті агента: від визначення типів до запису, пошуку, використання й забування](https://file1.kamacoder.com/i/web/20260526175848_agent_memory_09_memory_lifecycle_compressed.png)
