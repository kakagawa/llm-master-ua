---
title: Agent的记忆：短期记忆、长期记忆、RAG到底什么关系
description: Agent记忆怎么设计？本文讲清楚短期记忆、Session State、长期记忆、RAG知识库的区别和关系，为什么长期记忆不等于把所有聊天都塞进上下文，以及Agent系统如何做记忆写入、检索、更新、遗忘和面试回答，适合大模型应用开发和Agent面试复习。
keywords: ["Agent记忆", "AI Agent Memory", "短期记忆", "长期记忆", "Session State", "Conversation Buffer", "Agent和RAG关系", "Agent上下文管理", "Agent长期记忆设计", "大模型应用开发", "Agent面试"]
tags: ["大模型应用", "AI Agent", "Agent记忆", "RAG", "大模型面试"]
---
