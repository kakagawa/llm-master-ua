...
![Оцінювання агента потребує одночасного погляду на фінальну відповідь, траєкторію виконання й межі безпеки](https://file1.kamacoder.com/i/web/20260528163456_agent_evaluation_01_eval_layers_compressed.png)
...
![Результати задач агента градуються на повне виконання, часткове виконання, правильну й хибну невдачу](https://file1.kamacoder.com/i/web/20260528163457_agent_evaluation_02_task_outcome_compressed.png)
...
![Ефективність кроків агента вимірюється ключовим шляхом, марними й повторними викликами](https://file1.kamacoder.com/i/web/20260528163458_agent_evaluation_03_step_efficiency_compressed.png)
...
![Якість викликів інструментів оцінюється за вибором, параметрами, моментом виклику й розумінням результату](https://file1.kamacoder.com/i/web/20260528163459_agent_evaluation_04_tool_call_quality_compressed.png)
...
![Оцінювання відновлення після помилок за розумними наступними діями для різних типів збоїв](https://file1.kamacoder.com/i/web/20260528163500_agent_evaluation_05_error_recovery_compressed.png)
...
![Набір для оцінювання агента має покривати нормальне виконання, брак інформації, збої інструментів, високоризикові дії та шум](https://file1.kamacoder.com/i/web/20260528163502_agent_evaluation_06_eval_dataset_compressed.png)
...
![Процес оцінювання агента поєднує автоматичні правила, ручну вибірку, аналіз причин невдач і регресійне оцінювання](https://file1.kamacoder.com/i/web/20260528163503_agent_evaluation_07_auto_human_eval_compressed.png)
...
![Моніторинг агента в продакшні: збір trace, панель метрик, відтворення аномалій і регресія при поетапному викочуванні](https://file1.kamacoder.com/i/web/20260528163504_agent_evaluation_08_online_monitoring_compressed.png)
