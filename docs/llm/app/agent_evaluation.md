---
title: Agent怎么评估？AI Agent任务完成率、步骤效率、错误恢复率和可靠性度量
description: Agent怎么评估？本文讲清楚AI Agent评估不能只看最终答案，要从任务完成率、步骤效率、工具调用正确率、错误恢复率、权限安全、上下文污染和人工评测多维度衡量，适合大模型应用开发、Agent项目落地和大模型面试复习。
keywords: ["Agent评估", "AI Agent评估", "Agent Evaluation", "任务完成率", "步骤效率", "工具调用正确率", "错误恢复率", "Agent可靠性", "Agent评估指标", "大模型应用开发", "Agent面试", "LLM Evaluation"]
tags: ["大模型应用", "AI Agent", "Agent评估", "大模型面试", "LLM评估"]
---
...
前面 [Agent 为什么容易翻车](./agent_failure_modes.md) 里讲死循环，本质就是这个。
