...
![Порівняння споживання відеопам'яті при повному донавчанні та LoRA](https://file1.kamacoder.com/i/web/20260614152712_lora_01_memory_breakdown.png)
...
![Повне донавчання оновлює всю матрицю ваг, а LoRA вчить лише низькорангові матриці збоку](https://file1.kamacoder.com/i/web/20260614152715_lora_02_full_vs_lora.png)
...
![Низькоранговий розклад розбиває велику матрицю приросту на дві вузькі маленькі](https://file1.kamacoder.com/i/web/20260614152718_lora_03_low_rank.png)
...
![QLoRA квантизує заморожену базову модель у 4 біти, а адаптер LoRA лишається у високій точності](https://file1.kamacoder.com/i/web/20260614152721_lora_04_qlora.png)
...
![Одна базова модель із кількома адаптерами LoRA, що перемикаються за потребою](https://file1.kamacoder.com/i/web/20260614152724_lora_05_multi_adapter.png)
