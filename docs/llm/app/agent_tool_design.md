...
![Дизайн інструментів визначає стелю агента: розмиті інструменти змушують гадати, чіткі дають стабільні дії](https://file1.kamacoder.com/i/web/20260520110147_agent_tool_design_01_bad_vs_good_tool_compressed.png)
...
![Опис інструмента має містити межі: що вміє, чого не робить, коли застосовувати передусім](https://file1.kamacoder.com/i/web/20260520110153_agent_tool_design_05_description_boundary_compressed.png)
...
![Схема параметрів звужує свободу моделі до керованого діапазону](https://file1.kamacoder.com/i/web/20260520110154_agent_tool_design_06_parameter_schema_funnel_compressed.png)
...
![Відповідь інструмента має давати агенту змогу вирішити наступний крок](https://file1.kamacoder.com/i/web/20260520110156_agent_tool_design_07_return_value_decision_compressed.png)
...
![Хороший інструмент — це чіткий контракт: опис, параметри, відповідь і семантика помилок](https://file1.kamacoder.com/i/web/20260520110149_agent_tool_design_02_tool_contract_compressed.png)
...
![Гранулярність інструментів: надто дрібні рвуться, надто великі виходять з-під контролю](https://file1.kamacoder.com/i/web/20260520110150_agent_tool_design_03_tool_granularity_compressed.png)
...
![Інструментам із побічними ефектами потрібні межі: спершу чернетка, потім підтвердження, далі виконання й аудит](https://file1.kamacoder.com/i/web/20260520110152_agent_tool_design_04_side_effect_boundary_compressed.png)
...
![Повідомлення про помилку має підказувати агенту, як відновитися](https://file1.kamacoder.com/i/web/20260520110158_agent_tool_design_08_error_recovery_compressed.png)
...
![Динамічний набір інструментів: агент отримує лише релевантні задачі інструменти](https://file1.kamacoder.com/i/web/20260520110200_agent_tool_design_09_dynamic_toolbox_compressed.png)
