...
![Мал. 1. Тимчасові правила з чату розмиваються контекстом, а CLAUDE.md осаджує довгострокові правила в стабільні обмеження](https://file1.kamacoder.com/i/web/20260527112101_claude_md_01_positioning_compressed.png)
...
![Мал. 2. Різні типи інформації треба розводити між README, промптом, CLAUDE.md і пам'яттю користувача](https://file1.kamacoder.com/i/web/20260527112102_claude_md_02_boundaries_compressed.png)
...
![Мал. 3. Багаторівневі CLAUDE.md завантажуються за шляхом задачі, щоб правила нерелевантних модулів не забруднювали контекст](https://file1.kamacoder.com/i/web/20260527112104_claude_md_03_scope_compressed.png)
...
![Мал. 4. Чи потрапить інформація в CLAUDE.md, вирішують три критерії: повторюваність, дієвість і підтримуваність](https://file1.kamacoder.com/i/web/20260527112106_claude_md_04_decision_compressed.png)
...
![Мал. 5. Головна цінність поділу CLAUDE.md у великому проєкті — менше нерелевантних правил у бюджеті контексту](https://file1.kamacoder.com/i/web/20260527112108_claude_md_05_context_budget_compressed.png)
