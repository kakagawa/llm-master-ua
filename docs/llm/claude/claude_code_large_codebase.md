...
![Мал. 1. Причина, чому агент губиться у великій кодовій базі, — не кількість файлів, а кількість можливих входів](https://file1.kamacoder.com/i/web/20260527192245_claude_large_codebase_01_complexity_compressed.png)
...
![Мал. 2. В активній кодовій базі індекс легко розходиться з реальністю, тож Claude Code більше покладається на живий пошук у поточній робочій копії](https://file1.kamacoder.com/i/web/20260527192246_claude_large_codebase_02_index_drift_compressed.png)
...
![Мал. 3. Агентський пошук — це не разовий пошук відповіді, а поступове звуження кола за новими доказами](https://file1.kamacoder.com/i/web/20260527192247_claude_large_codebase_03_agentic_search_compressed.png)
...
![Мал. 4. Керування контекстом має уникати і сліпого пошуку через брак контексту, і розмивання уваги через його надлишок](https://file1.kamacoder.com/i/web/20260527192249_claude_large_codebase_04_context_governance_compressed.png)
...
![Мал. 5. На одній і тій самій задачі шлях виконання Claude Code із harness і без нього геть різний](https://file1.kamacoder.com/i/web/20260527192250_claude_large_codebase_05_harness_paths_compressed.png)
...
![Мал. 6. Кореневий CLAUDE.md задає напрямок, а CLAUDE.md підтек і скіли підвантажують локальні знання на вимогу](https://file1.kamacoder.com/i/web/20260527192251_claude_large_codebase_06_context_routing_compressed.png)
...
![Мал. 7. Hooks перетворюють нагадування моделі на автоматичне виконання й повертають набутий досвід у правила проєкту](https://file1.kamacoder.com/i/web/20260527192252_claude_large_codebase_07_hooks_feedback_compressed.png)
...
![Мал. 8. Plugins, MCP, LSP і субагенти — різні за природою речі: вони розв'язують задачі поширення, під'єднання, локалізації та ізоляції](https://file1.kamacoder.com/i/web/20260527192254_claude_large_codebase_08_component_boundaries_compressed.png)
...
![Мал. 9. Ключ до впровадження Claude Code у команді — перетворити особистий досвід на повторно вживані інженерні активи](https://file1.kamacoder.com/i/web/20260527192255_claude_large_codebase_09_team_asset_loop_compressed.png)
